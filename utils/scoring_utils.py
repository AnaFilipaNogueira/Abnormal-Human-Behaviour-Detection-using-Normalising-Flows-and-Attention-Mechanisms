...
def get_dataset_scores(scores, metadata, args=None):
    ...
    if args.dataset == 'UBnormal':
        pose_segs_root = args.data_dir + 'UBnormal/pose/test' 
        ...
        per_frame_scores_root = args.data_dir + 'UBnormal/gt/' 
    
    elif args.dataset == 'ShanghaiTech' or  args.dataset == 'ShanghaiTech-HR':
        per_frame_scores_root = args.data_dir + 'ShanghaiTech/gt/test_frame_mask/' 
...
def get_clip_score(scores, clip, metadata_np, metadata, per_frame_scores_root, args):
    ...
    if os.path.isfile(clip_res_fn):
        clip_gt = np.load(clip_res_fn)
    else:
        print('clip_res_fn', clip_res_fn)
